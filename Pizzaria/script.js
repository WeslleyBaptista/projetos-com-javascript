...
pizzaJson.map((item, index)=>{
    ...
    // CÓDIGO DA PRIMEIRA PÁGINA INICIAL
...
// FUNÇÃO DE FECHAMENTO DO MODAL AO CLICAR NO BOTÃO DE CANCELAR OU VOLTAR
function closeModal(){
    c('.pizzaWindowArea').style.opacity = 0
...
// EVENTOS DE CLICK NO BOTÃO DE QUANTIDADE DAS PIZZAS
...
// EVENTOS DE CLICK RELACIONADO AO BOTÃO DE TAMANHO DAS PIZZAS
...
// EVENTO DE CLICK NO BOTÃO DE ADICIONAR AO CARRINHO
